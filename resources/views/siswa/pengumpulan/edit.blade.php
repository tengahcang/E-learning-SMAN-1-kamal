...
<div class="container">
    ...
    <form action="{{ route('student.pengumpulan.update', ['pengumpulan' => $submision->id]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="form-group">
            <input type="textarea" name="content" id="content" value="{{ $errors->any() ? old('name') : $submision->content }}">
        </div>
