                ...
                <tbody>
                    @foreach ($classes as $index => $class)
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    <a href="{{ route('classes.show', ['class'=> $class->id]) }}" class="btn btn-outline-dark btn-sm me-2"><i class="bi-person-lines-fill"></i></a>
                                    <a href="{{ route('classes.edit', ['class'=> $class->id]) }}" class="btn btn-outline-dark btn-sm me-2"><i class="bi-pencil-square"></i></a>
                                    <div>
