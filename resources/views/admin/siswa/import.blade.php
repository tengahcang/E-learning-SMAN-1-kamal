...
@section('content')
    ...
    <div class="container">
        ...
        <div class="card bg-white border-0 shadow-sm">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h5 class="card-title">INPUT DATA EXCEL SISWA</h5>
                    <a href="{{ route('students.download.form') }}" class="btn btn-success btn-ijo">Download Template Excel</a>
                </div>
                <form action="{{ route('students.import') }}" method="POST" class="mt-5" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <div class="upload-area"
                            ...
                            <label for="file-upload" class="btn btn-primary upload-label"
                                style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);background-color:transparent;border:0px;color:black">Choose
                                File Or Drag Here</label>
                            <input type="file" id="file-upload" name="file" style="display: none;" required>
                        </div>
                    </div>
